<?php include('partials/menu.php') ;?>
        ...
        <div class = "main-content">
            <div class="wrapper">
                   ...
                   <a href="add-register.php" class="btn-primary">Add Register</a>
                   ...
                   <table class="tbl-full">
                    ...
                    if($res==TRUE){
                        ...
                        <td>
                            <a href="<?php echo SITEURL; ?>admin/delete-register.php?id=<?php echo $id; ?>" class="btn-danger">Delete Register</a>
